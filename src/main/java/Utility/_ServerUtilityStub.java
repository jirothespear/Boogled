...
public class _ServerUtilityStub extends org.omg.CORBA.portable.ObjectImpl implements Utility.ServerUtility
{
  ...
  public boolean checkWord (String answer, String playerID, String gameID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return checkWord (answer, playerID, gameID        );
            } finally {
                _releaseReply ($in);
            }
  } // checkWord

  public void startGame (String user) throws Utility.GameStartException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
