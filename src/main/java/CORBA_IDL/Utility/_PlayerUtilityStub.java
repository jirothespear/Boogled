...
public class _PlayerUtilityStub extends org.omg.CORBA.portable.ObjectImpl implements PlayerUtility
{
  ...
  public int getWinsCount (String username, String gameId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getWinsCount", true);
                $out.write_wstring (username);
                $out.write_wstring (gameId);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                ...
                return getWinsCount (username, gameId        );
            } finally {
                _releaseReply ($in);
            }
  } // getWinsCount
  ...
  public int getActiveGames ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getActiveGames", true);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public void reconnect (String username, String gameId, ClientCallback callback)
  {
            ...
            try {
                ...
                $out.write_wstring (username);
                $out.write_wstring (gameId);
                ClientCallbackHelper.write ($out, callback);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                reconnect (username, gameId, callback        );
            } finally {
                _releaseReply ($in);
            }
  } // reconnect
