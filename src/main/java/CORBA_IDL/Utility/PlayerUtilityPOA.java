 ...
 implements PlayerUtilityOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getActiveGames", new java.lang.Integer (15));
    _methods.put ("reconnect", new java.lang.Integer (16));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 15:  // Utility/PlayerUtility/getActiveGames
       {
         int $result = (int)0;
         $result = this.getActiveGames ();
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 16:  // Utility/PlayerUtility/reconnect
       {
         String username = in.read_wstring ();
         String gameId = in.read_wstring ();
         ClientCallback callback = ClientCallbackHelper.read (in);
         this.reconnect (username, gameId, callback);
         out = $rh.createReply();
         break;
       }
