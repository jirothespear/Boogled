...
/**
* CORBA_IDL.Utility/ClientCallbackPOA.java .
...
public abstract class ClientCallbackPOA extends org.omg.PortableServer.Servant
 implements CORBA_IDL.Utility.ClientCallbackOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CORBA_IDL.Utility/ClientCallback/startRound
       {
         String $result = null;
       ...
       case 1:  // CORBA_IDL.Utility/ClientCallback/roundEnd
       {
       ...
       case 2:  // CORBA_IDL.Utility/ClientCallback/gameFinish
       {
       ...
       case 3:  // CORBA_IDL.Utility/ClientCallback/getScore
       {
       ...
       case 4:  // CORBA_IDL.Utility/ClientCallback/getRoundTime
       {
         int time = in.read_long ();
       ...
       case 5:  // CORBA_IDL.Utility/ClientCallback/getQueueTime
       {
         int time = in.read_long ();
       ...
       case 6:  // CORBA_IDL.Utility/ClientCallback/getLetterChoice
       {
       ...
       case 7:  // CORBA_IDL.Utility/ClientCallback/getChampion
       {
  ...
  private static String[] __ids = {
    "IDL:CORBA_IDL.Utility/ClientCallback:1.0"};
